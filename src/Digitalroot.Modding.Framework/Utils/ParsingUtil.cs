using Digitalroot.Modding.Framework.Common.Extensions;
using System;
...
namespace Digitalroot.Modding.Framework.Utils
{
  ...
  {
    private const string StandardTimeFormat = "hh:mm ampm";
    ...
    public static TimeSpan? ParseTimeSpan(this string time, string format = StandardTimeFormat)
    {
      TimeSpan? ts;
