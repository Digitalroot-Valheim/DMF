...
namespace Digitalroot.Modding.Framework.Names.Vanilla
{
  ...
  {
    public static readonly IEnumerable<string> AllNames = DMF_Utils.ReflectionUtils.AllNames(typeof(ItemDropNames));
    ...
    public static string AsksvinEgg = PrefabNames.AsksvinEgg;
    public static string AsksvinMeat = PrefabNames.AsksvinMeat;
    ...
    public static string AxeWood = PrefabNames.AxeWood;
    ...
    public static string BjornHide = PrefabNames.BjornHide;
    public static string BjornMeat = PrefabNames.BjornMeat;
    public static string BjornPaw = PrefabNames.BjornPaw;
