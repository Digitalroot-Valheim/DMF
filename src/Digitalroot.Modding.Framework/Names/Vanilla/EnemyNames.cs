...
namespace Digitalroot.Modding.Framework.Names.Vanilla
{
  ...
  public static partial class EnemyNames
  {
    ...
    public static readonly string AxeBerzerkr = PrefabNames.AxeBerzerkr;
    public static readonly string AxeBerzerkrBlood = PrefabNames.AxeBerzerkrBlood;
    public static readonly string AxeBerzerkrLightning = PrefabNames.AxeBerzerkrLightning;
    public static readonly string AxeBerzerkrNature = PrefabNames.AxeBerzerkrNature;
    ...
    public static readonly string CharredArcher = PrefabNames.CharredArcher;
    public static readonly string CharredArcherFader = PrefabNames.CharredArcherFader;
    public static readonly string CharredMage = PrefabNames.CharredMage;
    public static readonly string CharredMelee = PrefabNames.CharredMelee;
    public static readonly string CharredMeleeDyrnwyn = PrefabNames.CharredMeleeDyrnwyn;
    public static readonly string CharredMeleeFader = PrefabNames.CharredMeleeFader;
    public static readonly string CharredTwitcher = PrefabNames.CharredTwitcher;
    public static readonly string Crow = PrefabNames.Crow;
    public static readonly string Deathsquito = PrefabNames.Deathsquito;
    public static readonly string DarkwoodWolf = PrefabNames.DarkwoodWolf;
    ...
    public static readonly string DvergerArbalest = PrefabNames.DvergerArbalest;
    public static readonly string DvergerAshlands = PrefabNames.DvergerAshlands;
    public static readonly string DvergerMage = PrefabNames.DvergerMage;
    public static readonly string DvergerMageFire = PrefabNames.DvergerMageFire;
    public static readonly string DvergerMageIce = PrefabNames.DvergerMageIce;
    public static readonly string DvergerMageSupport = PrefabNames.DvergerMageSupport;
    public static readonly string FallenValkyrie = PrefabNames.FallenValkyrie;
    public static readonly string Fenring = PrefabNames.Fenring;
    public static readonly string FenringCultist = PrefabNames.FenringCultist;
    public static readonly string FenringCultistHildir = PrefabNames.FenringCultistHildir;
    public static readonly string FenringCultistHildirNochest = PrefabNames.FenringCultistHildirNochest;
    public static readonly string FulingTrap = PrefabNames.FulingTrap;
    public static readonly string FulingTurret = PrefabNames.FulingTurret;
    ...
    public static readonly string GoblinBruteHildir = PrefabNames.GoblinBruteHildir;
    public static readonly string GoblinBruteBros = PrefabNames.GoblinBruteBros;
    ...
    public static readonly string Morgen = PrefabNames.Morgen;
    public static readonly string MorgenNonSleeping = PrefabNames.MorgenNonSleeping;
    ...
    public static readonly string SeekerAspic = PrefabNames.SeekerAspic;
    public static readonly string SeekerBrood = PrefabNames.SeekerBrood;
    public static readonly string Serpent = PrefabNames.Serpent;
    public static readonly string Skeleton = PrefabNames.Skeleton;
    public static readonly string SkeletonFriendly = PrefabNames.SkeletonFriendly;
    public static readonly string SkeletonHildir = PrefabNames.SkeletonHildir;
    public static readonly string SkeletonHildirNochest = PrefabNames.SkeletonHildirNochest;
    ...
    public static readonly string Ulv = PrefabNames.Ulv;
    public static readonly string Volture = PrefabNames.Volture;
