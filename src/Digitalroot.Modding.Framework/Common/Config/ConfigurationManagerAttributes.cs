...
namespace Digitalroot.Modding.Framework.Common.Config
{
  /// <summary>
  ...
  public sealed class ConfigurationManagerAttributes
  {
    ...
    private static readonly string _namespace = $"Digitalroot.Valheim.Common.Config.{nameof(ConfigurationManagerAttributes)}";
