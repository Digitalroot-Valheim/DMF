...
namespace DMF.Common
{
  ...
  public sealed class Log
  {
...
#if DEBUG
      TraceLoggers.Add(nameof(DMF), new TraceLogger(nameof(DMF), true));
#else
      TraceLoggers.Add(nameof(DRMF), new TraceLogger(nameof(DRMF), false));
#endif
    }
    ...
    {
      return TraceLoggers.TryGetValue(sender.Source, out var logger) ? logger : TraceLoggers[nameof(DMF)];
    }
